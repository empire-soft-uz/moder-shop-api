...
sliderRouter.post("/new", validateAdmin_1.default, [...SliderRules_1.sliderCreation], upload.single("image"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
sliderRouter.delete("/delete/:id", validateAdmin_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
